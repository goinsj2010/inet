...
#include "inet/networklayer/common/EchoDissector.h"
...
Register_Protocol_Dissector(&Protocol::echo, EchoDissector);

void EchoDissector::dissect(Packet *packet, ICallback& callback) const
{
