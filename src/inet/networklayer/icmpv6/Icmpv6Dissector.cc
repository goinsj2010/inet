...
#include "inet/networklayer/icmpv6/Icmpv6Dissector.h"
...
Register_Protocol_Dissector(&Protocol::icmpv6, Icmpv6Dissector);

void Icmpv6Dissector::dissect(Packet *packet, ICallback& callback) const
{
    bool isBadPacket = !Icmpv6::verifyCrc(packet);
    const auto& header = packet->popHeader<Icmpv6Header>();
