...
#include "inet/routing/pim/PimDissector.h"
...
Register_Protocol_Dissector(&Protocol::pim, PimDissector);

void PimDissector::dissect(Packet *packet, ICallback& callback) const
{
