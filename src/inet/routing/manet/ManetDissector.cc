...
#include "inet/routing/manet/ManetDissector.h"
...
Register_Protocol_Dissector(&Protocol::manet, ManetDissector);

void ManetDissector::dissect(Packet *packet, ICallback& callback) const
{
...
//    ASSERT(packet->getDataLength() == B(0));
    callback.dissectPacket(packet, nullptr);    //FIXME KLUDGE
